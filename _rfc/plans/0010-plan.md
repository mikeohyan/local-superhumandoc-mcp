...
- [x] **Step 1: Confirm the scaffold's claims are now covered elsewhere**
...
- [x] **Step 3: Verify the built package still runs a real stdio session**
...
- [x] **Step 4: Audit for leaks and citation violations**
