...
|---|---|---|---|
| `upstream-api` | 0008 | Accepted | `_rfc/0008-api-version-lock-and-advisory-rate-limits.md` |
| `config-resolution` | 0006 | Accepted | `_rfc/0006-credential-and-config-resolution.md` |
